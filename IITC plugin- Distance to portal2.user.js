...
// @version        0.1.1.20170108.21732
// @namespace      https://github.com/jonatkins/ingress-intel-total-conversion
// @updateURL      https://static.iitc.me/build/release/plugins/distance-to-portal.meta.js
// @downloadURL    https://static.iitc.me/build/release/plugins/distance-to-portal.user.js
// @description    [iitc-2017-01-08-021732] Allows your current location to be set manually, then shows the distance to the selected portal. Useful when managing portal keys.
...
window.plugin.distanceToPortal.setLocation = function() {
  if (window.plugin.distanceToPortal.currentLocMarker) {
    ...
    window.plugin.distanceToPortal.currentLoc = 0; // bacon9000 was here 20200924
    return;
  }
